...
function Handle_Operator(Next_Operator) {
    ...
    //when a n operator key is pressed, we convert the current number
    ...
    if (First_Operand == null) {
        ...
        //if operator exists, property lookup is performed fo the operator
...
keys.addEventListener('click', (event) => {
    // the target variabl is an object that represents the element
    // that was clicked
    const { target } = event;
